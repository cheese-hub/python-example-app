...
This is an example Jupyter-based Python application running in Docker.

The application is packaged as a Docker image that can be run as part of the [CHEESEHub](https://hub.cheesehub.org/) platform.
