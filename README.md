...
By including a small [AppSpec JSON](./integration/appspec.json) file describing how to run it, this same Docker image can run inside of the [CHEESEHub](https://hub.cheesehub.org/) platform.
